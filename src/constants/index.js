...
const experiences = [
  {
    title: "Jamhuriya University of Science and Technology",
    company_name: "Bachelor of Computer Science and IT",
    icon: starbucks,
    iconBg: "#383E56",
    date: "AUGUEST 2019 - AUGUEST 2023",
    points: [
...
const projects = [
  {
    ...
    description:
      "The Online Doctor Appointment System allows patients to select a desired doctor appointment date through the online platform. This project is developed using the MERN stack technology, ",
    tags: [
      {
        name: "react",
